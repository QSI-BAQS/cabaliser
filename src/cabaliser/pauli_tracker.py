from ctypes import Structure, POINTER, c_size_t, c_uint32, c_void_p

from cabaliser.utils import deref, INF

from cabaliser.structs import PartialOrderGraphType, ScheduleDependencyType
...
class PauliTracker:
    ...
    def construct_measurement_schedule(self):
        '''
            ...
            the rust library
        '''
        if self.measurement_schedule is not None:
